...
- Os manifests principal e administrativo agora declaram `dir="ltr"`, coerente com a interface `pt-BR`; a auditoria de identidade PWA bloqueia regressões que removam ou alterem essa direção de texto.
