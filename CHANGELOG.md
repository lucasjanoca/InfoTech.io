...
- A auditoria de identidade PWA agora rejeita `display_override` com valores vazios, duplicados ou fora dos modos suportados, preservando `standalone` como primeira prioridade da experiência instalada sem alterar o manifest publicado.
