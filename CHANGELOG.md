...
- Nova auditoria dedicada rejeita barras invertidas em URLs de atributos HTML navegáveis/carregáveis (`href`, `src`, `action`, `formaction` e `poster`), evitando destinos ambíguos que navegadores possam normalizar como separadores de URL sem alterar as páginas publicadas.
